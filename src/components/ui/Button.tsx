...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold tracking-tight transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] focus:outline-none focus:ring-2 focus:ring-accent-primary/50 disabled:opacity-50 disabled:cursor-not-allowed';
  
  const sizeStyles = {
    sm: 'text-xs px-4 py-2 rounded-lg gap-2',
    md: 'text-sm sm:text-base px-6 py-3 rounded-xl gap-2.5',
    lg: 'text-base sm:text-lg px-8 py-4 rounded-xl gap-3 font-bold',
  };
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent text-text-primary border-2 border-border-medium hover:border-accent-primary hover:text-accent-primary hover:bg-accent-glow active:scale-[0.98]',
